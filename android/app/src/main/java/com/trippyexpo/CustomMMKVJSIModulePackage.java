package com.trippyexpo; // Change to your android package name
...
public class CustomMMKVJSIModulePackage extends ReanimatedJSIModulePackage { // Replace with ReanimatedJSIModulePackage 
    @Override
